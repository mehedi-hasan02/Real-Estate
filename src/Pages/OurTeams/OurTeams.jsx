            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3'>
                <div className="card w-96 bg-base-100 shadow-xl">
                    <figure className="px-10 pt-10">
                        <img src={PR} alt="Shoes" className="rounded-xl" />
                    </figure>
                    <div className="card-body items-center text-center">
                        ...
                        <div>
                            <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quis consectetur minus iusto eius. Corporis natus voluptas reiciendis facere quasi dolorum saepe tenetur esse commodi tempora distinctio, fugit odit. Numquam, quas?</p>
                        </div>
                    </div>
                </div>
                <div className="card w-96 bg-base-100 shadow-xl">
